...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Call.location_name'
        db.add_column('phone_call', 'location_name',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Call.client_name'
        db.add_column('phone_call', 'client_name',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Call.location_name'
        db.delete_column('phone_call', 'location_name')

        # Deleting field 'Call.client_name'
        db.delete_column('phone_call', 'client_name')
