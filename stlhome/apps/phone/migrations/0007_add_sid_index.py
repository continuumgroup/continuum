...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ClientCall', fields ['sid']
        db.create_index('phone_clientcall', ['sid'])


    def backwards(self, orm):
        # Removing index on 'ClientCall', fields ['sid']
        db.delete_index('phone_clientcall', ['sid'])


    models = {
        'phone.clientcall': {
            'Meta': {'object_name': 'ClientCall'},
            ...
            'sid': ('django.db.models.fields.CharField', [], {'max_length': '34', 'db_index': 'True'}),
