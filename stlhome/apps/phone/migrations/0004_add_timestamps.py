...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Call.created_at'
        db.add_column('phone_call', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 6, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Call.updated_at'
        db.add_column('phone_call', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 6, 4, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Call.created_at'
        db.delete_column('phone_call', 'created_at')

        # Deleting field 'Call.updated_at'
        db.delete_column('phone_call', 'updated_at')
